...
export default function About() {
  return (
    <>
      ...
      <div className="row bg-dark p-3 text-white mx-auto" style={{ maxWidth: "100%" }}>
        <div className="col-sm-5">
          <h4 className="text-danger">Nyyay sahayak</h4>
        ...
        <div className="col-sm-4">
          ...
          <p><i className="far fa-envelope" style={{ backgroundColor: "grey" }}></i> <a href="mailto:srishmaalladi14@gmail.com" className="text-decoration-none">Send Email</a></p>
          <p><i className="fas fa-phone"></i> 6305836536</p>
        </div>
      </div>
